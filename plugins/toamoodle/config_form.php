...
class etl_plugin_config_form extends moodleform {
    ...
    public function __construct($id) {
        $this->plugin = new \local_etl\toamoodle_extractor($id, null, null, true);
        parent::__construct();
    }
    ...
    public function definition() {
        ...
        $label = get_string('toaaccessurl', 'localetl_toamoodle');
        ...
        $label = get_string('externaltoaaccessurl', 'localetl_toamoodle');
        ...
        $label = get_string('publickey', 'localetl_toamoodle');
        ...
        $elm = & $mform->addElement('checkbox', 'masquerade', get_string('masquerade', 'localetl_toamoodle'));
        $mform->setDefault('masquerade', @$this->plugin->masquerade);

        $label = get_string('lastextract', 'localetl_toamoodle');
        ...
        $label = get_string('lastextractactions', 'localetl_toamoodle');
        ...
        $label = get_string('lastextractacademics', 'localetl_toamoodle');
        ...
        $label = get_string('lastextractdocuments', 'localetl_toamoodle');
        ...
        $label = get_string('lastextractcommunications', 'localetl_toamoodle');
        ...
        $label = get_string('lastextractgrades', 'localetl_toamoodle');
